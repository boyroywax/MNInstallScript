...
function doSoakRainDrizzle(bot, message, tipper, words, helpmsg, tipType, cmdOffset) {
  ...
  if (amount === null) {
    ...
    message.reply("Atleast 0.01 PRIV is required to rain").then(message => message.delete(5000));
    return;
  }
...
function getPrice(bot, msg){
  getDataFromAPI("https://www.coinexchange.io/api/v1/getcurrency?ticker_code=TIGC", true, function(data){
...
function getBlock(bot, msg){
  getDataFromAPI("https://explorer.privcy.io:3001/api/getblockcount", true, function(result){
    if (result !== "undefined") {
      if (result) {
...
function getWeight(bot, msg){
  getDataFromAPI("https://explorer.privcy.io:3001/api/getdifficulty", true, function(result){
    if (result !== "undefined") {
      if (result) {
...
function getSupply(bot, msg){
  getDataFromAPI("https://explorer.privcy.io:3001/ext/getmoneysupply", true, function(result){
    if (result !== "undefined") {
      if (result) {
        sendEmbedMessages(msg, "", 0xF55555, [{
