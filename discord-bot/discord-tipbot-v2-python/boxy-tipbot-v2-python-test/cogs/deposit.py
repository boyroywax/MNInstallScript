...
class Deposit:
    ...
    async def deposit(self, ctx):
        ...
        await self.bot.say(user.mention + "'s Deposit Address: `" + str(user_addy) + "`" + "\n\nRemember to use $balance to check your balance and not an explorer. The address balance and your actual balance are not always the same!\n\n:warning: DISCLAIMER: This is BETA software! Do not send large amounts of BOXY! The developers are not reliable for any lost BOXY!\n\n REMINDER: Staking BOXY is easy at StakeCube.net - https://stakecube.net/?team=BOXY :warning:")
