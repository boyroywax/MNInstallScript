...
class Txlist:
    ...
    async def do_stake_embed(self, name, db_bal, db_bal_unconfirmed, stake_total_amt, stake_total_received, reg_users_eligible):
        ...
        embed.add_field(name="Enabled", value=self.is_enabled)
        embed.add_field(name="Staking Status", value=self.staking_status)
        # embed.add_field(name="Errors", value=self.have_errors)
        embed.add_field(name="Weight", value="{}".format(int(self.weight)))
        embed.add_field(name="Net Staking Weight", value="{}".format(int(self.net_staking_weight)))
        embed.add_field(name="Expect Time", value="{}".format(int(self.expected_time)))
