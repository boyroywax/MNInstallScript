...
class Withdraw:
    ...
    async def withdraw(self, ctx, address: str, amount: float):
        ...
        # await self.bot.say("{} is the account name :warning:".format(account_name))
        ...
        if txid is None:
            ...
            embed.add_field(name="Withdrawal Transactions", value="Type $wlist for a list of your withdrawals.")
